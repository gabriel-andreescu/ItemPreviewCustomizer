...
TEST_CASE("RotationDegreesToMarkerValue follows CommonLib BSInvMarker conversion", "[preview-marker-math]") {
    CHECK(RotationDegreesToMarkerValue(0.0F) == 0);
    CHECK(RotationDegreesToMarkerValue(90.0F) == 1638);
    CHECK(RotationDegreesToMarkerValue(180.0F) == 3277);
